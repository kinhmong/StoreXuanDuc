<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Ác Ma Điện Cơ Sở 1 </a></li>
						<li><a href=""><i class="fa fa-phone"></i> 1900 100 có</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="source/assets/dest/images/LOGO-XUÂN-ĐỨC.png" width="200px" alt=""></a>
				</div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('lienhe')}}">Liên hệ chủ cửa hàng</a></li>
					</ul>
					<div class="clearfix"></div>
				</nav>
			</div> <!-- .container -->
